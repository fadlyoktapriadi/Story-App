...
abstract class AppLocalizations {
  ...
  /// **'Selamat datang di Storyfy'**
  String get loginWelcome;

  /// No description provided for @smallLoginTitle.
  ///
  /// In id, this message translates to:
  ...
  /// No description provided for @titleAddStory.
  ///
  /// In id, this message translates to:
  /// **'Tambah Cerita'**
  String get titleAddStory;

  /// No description provided for @placeholderDescription.
  ///
  /// In id, this message translates to:
  /// **'Masukan deskripsi cerita'**
